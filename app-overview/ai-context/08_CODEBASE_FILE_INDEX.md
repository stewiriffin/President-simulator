...
- `EspionageAndSecurityModels.kt` - instability/coup, espionage, covert missions
...
- `GameViewModel.kt` - action facade + tick orchestration
...
## Active Screen Layer (`ui/screens/`)
...
- `ScienceScreen.kt`
- `LawsScreen.kt`
- `GovernanceUNScreen.kt` (located at `ui/GovernanceUNScreen.kt`, active via nav)
